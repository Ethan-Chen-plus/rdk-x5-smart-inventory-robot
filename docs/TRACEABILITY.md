...
| Learned manipulation | Completed SmolVLA training and RTX PRO 6000 96 GB deployment | `smolvla/convert_recordings.py`, `smolvla/train_smolvla.ps1`, `smolvla/run_policy.py` |
